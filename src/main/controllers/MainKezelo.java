...
public class MainKezelo implements Initializable {
    ...
    private Boolean keszTorlesre = false;
     ...
     * hogy melyik fxml fájlokat nyissa meg.
     *
     * @param event - gombhoz
     */
    @FXML
    ...
    private void loadBookInfo2(ActionEvent event) {
        ...
        try {
            while(rs.next()){
                ...
                kiadData.add("Kiadás dátuma és ideje: " + mKiadTime.toString());
    ...
    /**
     * Itt tudjuk meghosszabbítani a kiadást akinek kivette a könyvet.
     *
     * @param event - gombhoz
     */
    @FXML
